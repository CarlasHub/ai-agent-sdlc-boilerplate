...
function verifyBuilderJourneyUi() {
  ...
  for (const expected of [
    ...
    'Governance-first agent delivery',
    'View package',
    'hero-gallery',
    'builder-stage',
    'gallery-frame',
    'NAV_TARGET_IDS',
    'CONFIG_SECTION_IDS',
    'DEFAULT_OPEN_CONFIG_SECTION_IDS',
    'configSection({',
    'data-action="toggle-config-section"',
    'setConfigSectionOpen',
    'openConfigSectionFromLink',
    'aria-expanded',
    'config-section-body',
    'currentNavTargetId',
    'updateWorkspaceNavActive',
  ...
  for (const expected of [
    ...
    '--surface-input: rgba(0, 2, 11, 0.78)',
    '--surface-active: rgba(179, 146, 63, 0.18)',
    '--accent-gold: #b3923f',
    '--accent-gold-soft: #d8bc76',
    '--section-blue-bg: rgba(167, 189, 212, 0.075)',
  ...
  for (const blockedColor of ['#e6edf3', '#0d1117', '#00dfff', '#32f29a', '#ff4c78']) {
